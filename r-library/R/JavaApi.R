...
#' Version: 0.02
#'
#' Generated: 2022-04-27T17:18:38.488
#'
...
JavaApi = R6::R6Class("JavaApi", public=list( 
    ...
    #' @return nothing
 	initialize = function(logLevel = "INFO") {
		...
		message("Generated: 2022-04-27T17:18:38.488")
		...
		.jcall(self$.log,returnSig = "V",method = "debug","R package generated: 2022-04-27T17:18:38.488");
